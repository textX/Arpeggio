...
@pytest.mark.parametrize(
    "parser", [ParserPEG(grammar, "calc"), ParserPEGClean(clean_grammar, "calc")]
)
...
def test_parse_input(parser):
    ...
    assert (
        str(result)
        == "4 | + | 5 | * | 7 | / | 3.45 | * | - | 45 | * | ( | 2.56 | + | 32 | ) | / | - | 56 | * | ( | 2 | - | 1.34 | ) | "  # noqa
    )
    assert (
        repr(result)
        == "[ [ [ [ number '4' [0] ] ],  '+' [1], [ [ number '5' [2] ],  '*' [3], [ number '7' [4] ],  '/' [5], [ number '3.45' [6] ],  '*' [10], [  '-' [11], number '45' [12] ],  '*' [14], [  '(' [15], [ [ [ number '2.56' [16] ] ],  '+' [20], [ [ number '32' [21] ] ] ],  ')' [23] ],  '/' [24], [  '-' [25], number '56' [26] ],  '*' [28], [  '(' [29], [ [ [ number '2' [30] ] ],  '-' [31], [ [ number '1.34' [32] ] ] ],  ')' [36] ] ] ], EOF [37] ]"  # noqa
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ParserPEGClean(clean_grammar, "calc", reduce_tree=True),
    ],
)
