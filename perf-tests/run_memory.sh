...
"${python_interpreter}" --version > "${own_dir}/reports/${1}_${report_date}_memory_report_nomemoization.txt" 2>&1
"${python_interpreter}" "${own_dir}/test_memory_nomemoization.py" >> "${own_dir}/reports/${1}_${report_date}_memory_report_nomemoization.txt"

"${python_interpreter}" --version > "${own_dir}/reports/${1}_${report_date}_memory_report_memoization.txt" 2>&1
"${python_interpreter}" "${own_dir}/test_memory_memoization.py" >> "${own_dir}/reports/${1}_${report_date}_memory_report_memoization.txt"
